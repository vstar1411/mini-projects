...
public class SubjectsActivity extends AppCompatActivity {
    ...
    //Show the message when help button is clicked
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //on clicking the image button show the mesage in a dialog box
        ...
        //stands behind UI and data that we want to represent
        ...
        mRecyclerView.setHasFixedSize(true);//for the animation
